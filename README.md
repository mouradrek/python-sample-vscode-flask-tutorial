[![Build Status](https://dev.azure.com/OneDSF/e-learning-Mourad/_apis/build/status%2Fmouradrek.python-sample-vscode-flask-tutorial?branchName=main)](https://dev.azure.com/OneDSF/e-learning-Mourad/_build/latest?definitionId=140&branchName=main)
